...
const web3 = new Web3("https://kovan.infura.io/v3/700be78778b349229366a4a40b1d5df2");
...
const providerInstance = new web3.eth.Contract(addressProviderABI, "0x88757f2f99175387ab4c6a4b3067c77a695b0349");
...
providerInstance.methods.getLendingPool().call().then((lendingPoolAddress) => {
  ...
  const account = '0xb5f62A0473154bb056B8CdBcC9F525B136eB3BbE'
  const privateKey1 = Buffer.from(process.env.PRIVATE_KEY_1, 'hex')
  console.log(lendingPoolInstance.methods.deposit(
    "0x6b175474e89094c44da98b954eedeac495271d0f", supplyValue, account))
