...
class StripeClient: NSObject,STPCustomerEphemeralKeyProvider {
    ...
    func createCustomerKey(withAPIVersion apiVersion: String, completion: @escaping
        ...
        let createCustomerEndPoint = URL(string: StripeClient.baseUrl + "empheralkey.php")
    ...
    class func createPaymentIntent(amount: Int, currency: String, customerId: String, completion:@escaping (String) -> Void) {
        let createCustomerEndPoint = URL(string: StripeClient.baseUrl + "createpaymentintent.php")
